...
public class Main2Activity extends AppCompatActivity {
            ...
            public void onClick(View v) {
                if(btnLocate.isChecked()){ //위치정보 수신 시작
                    try{
                        ...
                        Toast.makeText(getApplicationContext(), "내 위치 확인 요망" , Toast.LENGTH_SHORT).show();
    ...
    //LocationListener 구현
    //LocationListener 로부터 전달되는 취치정보를 받기위해 정의
    ...
    protected String locationInfo(Location location){
        ...
        double accuracy = location.getAccuracy(); //위치정확도(정밀도)
        ...
        switch (requestCode){
            case REQUEST_CODE :
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    Toast.makeText(this, "위치권한실패", Toast.LENGTH_SHORT).show();
                }
        }
    }
}//end main
