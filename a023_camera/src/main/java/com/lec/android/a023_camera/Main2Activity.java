...
public class Main2Activity extends AppCompatActivity {
        ...
        cameraSurfaceView.capture(new Camera.PictureCallback() {
            ...
            public void onPictureTaken(byte[] data, Camera camera) {
                ...
                if(outUriStr == null){
                    ...
                    sendBroadcast(new Intent( //이러한 이벤트가 발생되어서 자동으로 알려주는 메소드(카톡 자동친구등록)
    ...
    private class CameraSurfaceView extends SurfaceView implements SurfaceHolder.Callback{
        ...
        // SurfaceView 가 만들어질때, 카메라 객체를 참조한 후 미리보기 화면으로 홀더 객체 설정
        @Override
        ...
        //카메라 orientation 세팅(핸드폰을 들고 화면을 회전했을 때 기준점을 잡아주는게 orientation)
        public void setCameraOrientation(){
            ...
            int rotation = manager.getDefaultDisplay().getRotation(); //화면 회전값 얻어오기
            int degrees = 0;
