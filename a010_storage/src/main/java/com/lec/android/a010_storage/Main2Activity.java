...
public class Main2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //위험권한 획득
        if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && checkSelfPermission(String.valueOf(PERMISSIONS))
        ...
        btnSave.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(!checkExternalStorage()) return; //외부메모리 사용못하면 종료.
                ...
                try {
                    ...
                    FileWriter writer = new FileWriter(f, false); // true이면 append모드로 생성(false = write 모드)
        ...
        btnRead.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if(!checkExternalStorage()) return; //외부메모리 사용가능 여부체크
        ...
        switch (requestCode){
            case REQUEST_CODE:
                if(grantResults.length > 0 && grantResults[0] == PackageManager.PERMISSION_GRANTED){
                    ...
                    //만약 권한이 없으면 더이상 진행못하게 하든지 다른 조치를 취해야 한다.
                    // ex) onDestroy(); 직접 호출해도 된다.
                }
