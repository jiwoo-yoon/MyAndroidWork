...
public class Main3Activity extends AppCompatActivity {
    ...
    //방법1> 메인 스레드가 메인스레드 자신에게 메세지 보내기
    //sendEmptyMessageDelayed()
    public void mOnClick1(View v){
        new AlertDialog.Builder(this)
                .setTitle("질문 1")
                .setMessage("업로드 하시겠습니까?")
                .setPositiveButton("옙", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        mHandler.sendEmptyMessageDelayed(1, 3000);
                    }
                })
                .setNegativeButton("놉", null)
                .show();
    }

    /*  방법2> Handler 로 Runnable 을 지연(delay)하여 보냄(post)
...
//방법4> Timer, TimerTask 사용(java.util에 있는거임)
